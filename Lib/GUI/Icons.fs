    ...
    let refresh =
        Canvas.create [
            ...
            Canvas.children [
                Path.create [
                    Path.fill "black"
                    Path.data "M12,4C7.58,4 4,7.58 4,12C4,16.42 7.58,20 12,20C14.5,20 16.72,18.81 18.16,16.84L16.73,15.41C15.5,17.13 13.84,18.27 12,18.27C8.69,18.27 6,15.58 6,12C6,8.42 8.69,5.73 12,5.73C14.09,5.73 15.97,6.81 17.09,8.84L13,12.93V9H18V14H14.07L17.16,17.09C15.97,18.81 14.09,20 12,20C7.58,20 4,16.42 4,12C4,7.58 7.58,4 12,4Z"
                ]
            ]
        ]
